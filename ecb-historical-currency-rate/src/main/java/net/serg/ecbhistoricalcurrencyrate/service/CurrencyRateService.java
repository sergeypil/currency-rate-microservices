...
import net.serg.ecbhistoricalcurrencyrate.config.EcbConfig;
import net.serg.ecbhistoricalcurrencyrate.model.CachedCurrencyRates;
import net.serg.ecbhistoricalcurrencyrate.model.CurrencyRate;
import net.serg.ecbhistoricalcurrencyrate.parser.CurrencyRateParser;
