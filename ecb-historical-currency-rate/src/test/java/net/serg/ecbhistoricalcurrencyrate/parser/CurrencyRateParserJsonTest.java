...
class CurrencyRateParserJsonTest {

    @Test
    void parseTest() {
        //given
        var parser = new CurrencyRateParserJson();
        var ecbMockResponse = "{\n" +
                "   \"motd\":{\n" +
        ...
        //when
        var rates = parser.parse(ecbMockResponse);

        //then
        assertThat(rates.size()).isEqualTo(170);
    ...
    CurrencyRate getUSDrate() {
        return new CurrencyRate("USD", "0.002383");
    }

    CurrencyRate getEURrate() {
        return new CurrencyRate("EUR", "0.001975");
    }

    CurrencyRate getJPYrate() {
        return new CurrencyRate("RUB", "0.176256");
    }
}